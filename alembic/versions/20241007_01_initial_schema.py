...
def upgrade() -> None:
    ...
    peran_pengguna.create(op.get_bind())
    status_guru.create(op.get_bind())
    jenis_kelamin.create(op.get_bind())
    jenjang_sekolah.create(op.get_bind())
    status_sekolah.create(op.get_bind())
    kelompok_mapel.create(op.get_bind())
    status_siswa.create(op.get_bind())
    status_keanggotaan.create(op.get_bind())
    semester_enum.create(op.get_bind())
    tipe_penilaian.create(op.get_bind())
    status_kehadiran.create(op.get_bind())
    status_kenaikan.create(op.get_bind())
    jenis_pembayaran.create(op.get_bind())
    status_pembayaran.create(op.get_bind())
    status_tagihan.create(op.get_bind())
...
def downgrade() -> None:
    ...
    sa.Enum(name="statustagihan").drop(op.get_bind(), checkfirst=False)
    sa.Enum(name="statuspembayaran").drop(op.get_bind(), checkfirst=False)
    sa.Enum(name="jenispembayaran").drop(op.get_bind(), checkfirst=False)
    sa.Enum(name="statuskenaikan").drop(op.get_bind(), checkfirst=False)
    sa.Enum(name="statuskehadiran").drop(op.get_bind(), checkfirst=False)
    sa.Enum(name="tipepenilaian").drop(op.get_bind(), checkfirst=False)
    sa.Enum(name="semester").drop(op.get_bind(), checkfirst=False)
    sa.Enum(name="statuskeanggotaan").drop(op.get_bind(), checkfirst=False)
    sa.Enum(name="statussiswa").drop(op.get_bind(), checkfirst=False)
    sa.Enum(name="kelompokmatapelajaran").drop(op.get_bind(), checkfirst=False)
    sa.Enum(name="statussekolah").drop(op.get_bind(), checkfirst=False)
    sa.Enum(name="jenjangsekolah").drop(op.get_bind(), checkfirst=False)
    sa.Enum(name="jeniskelamin").drop(op.get_bind(), checkfirst=False)
    sa.Enum(name="statusguru").drop(op.get_bind(), checkfirst=False)
    sa.Enum(name="peranpengguna").drop(op.get_bind(), checkfirst=False)
